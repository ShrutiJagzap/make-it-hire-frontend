// // src/dashboard/AdminReports.jsx
...
//                 <Typography variant="h6">Interview Report: {selectedReport.candidate_name}</Typography>
//                 <Chip 
...
//                     <Typography variant="subtitle2" color="textSecondary">Resume Score</Typography>
//                     <Typography variant="h4">{selectedReport.resume_score}%</Typography>
//                   </Card>
//                 </Grid>
//                 <Grid item xs={6}>
//                   <Card variant="outlined" className="p-3">
//                     <Typography variant="subtitle2" color="textSecondary">Match Score</Typography>
//                     <Typography variant="h4">{selectedReport.match_score}%</Typography>
//                   </Card>
//                 </Grid>
//                 <Grid item xs={6}>
//                   <Card variant="outlined" className="p-3">
//                     <Typography variant="subtitle2" color="textSecondary">Interview Score</Typography>
//                     <Typography variant="h4">{selectedReport.interview_score}%</Typography>
//                   </Card>
//                 </Grid>
//                 <Grid item xs={6}>
//                   <Card variant="outlined" className="p-3">
//                     <Typography variant="subtitle2" color="textSecondary">Engagement</Typography>
//                     <Typography variant="h4">{selectedReport.engagement_score}%</Typography>
//                   </Card>
//                 </Grid>

//                 <Grid item xs={12}>
//                   <Divider className="my-2" />
//                   <Typography variant="subtitle1" className="font-bold mb-2">Skills Found</Typography>
//                   <Box className="flex flex-wrap gap-2">
//                     {selectedReport.skills_found?.map((skill, i) => (
//                       <Chip key={i} label={skill} className="bg-indigo-50" />
//                     ))}
//                   </Box>
//                 </Grid>

//                 <Grid item xs={12}>
//                   <Typography variant="subtitle1" className="font-bold mb-2">Recommendations</Typography>
...
//                   <Grid item xs={12}>
//                     <Typography variant="subtitle1" className="font-bold mb-2">Interview Q&A</Typography>
//                     {selectedReport.answers.map((ans, i) => (
//                       <Card key={i} variant="outlined" className="p-3 mb-2">
//                         <Typography variant="subtitle2" className="font-bold">Q: {ans.question}</Typography>
//                         <Typography variant="body2" className="mt-1">A: {ans.answer}</Typography>
//                         <Box className="flex gap-2 mt-2">
//                           <Chip size="small" label={`Score: ${ans.combined_score}%`} color="primary" />
//                           <Chip size="small" label={ans.feedback} variant="outlined" />
//                         </Box>
//                       </Card>
//                     ))}
//                   </Grid>
